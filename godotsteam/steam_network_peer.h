...
class SteamNetworkPeer : public MultiplayerPeer {
public:
	typedef MultiplayerPeer::ConnectionStatus ConnectionStatus;
...
private:
	GDCLASS(SteamNetworkPeer, MultiplayerPeer);
...
public:
	...
	void lobbyDataUpdate(uint8 success, uint64_t lobbyId, uint64_t memberId, uint32 key);
